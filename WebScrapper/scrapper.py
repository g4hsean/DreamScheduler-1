...
def getFallWinter():
    ...
    postVariables = {'__EVENTTARGET':'ctl00$PageBody$btn_ShowScCrs','__VIEWSTATE':viewState,'__EVENTVALIDATION':eventValidation,'ctl00$PageBody$ddlYear' : '2014', 'ctl00$PageBody$ddlSess':'3', 'ctl00$PageBody$ddlLevl':'U','ctl00$PageBody$ddlDept':'04'}
